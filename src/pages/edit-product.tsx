...
export default function EditProduct({ flower, setStartEdit, startEdit }: AdminViewProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    resetForm()
    console.log("Updating flower:", formData)
  }
          ...
          <CardContent >
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-slate-600 font-medium">Flower Name</Label>
                    <Input
                      id="name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="flower_category" className="text-slate-600 font-medium">Flower Type</Label>
                    <Input
                      id="flower_category"
                      placeholder="e.g., Hydrangeas, Roses, Tulips"
                      value={formData.flower_category || ""}
                      onChange={(e) => setFormData({ ...formData, flower_category: e.target.value })}
                      required
                      className="bg-white/80 border-purple-200 focus:border-purple-400 focus:ring-purple-200 rounded-xl"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="product_category" className="text-slate-600 font-medium">Product Type</Label>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent className="bg-white/95 backdrop-blur-sm border-purple-200 rounded-xl">
                        <SelectItem value="BOUQUET" className="focus:bg-purple-50">🌹 Bouquet</SelectItem>
                        <SelectItem value="SINGLE_FLOWER" className="focus:bg-purple-50">🌸 Single Flower</SelectItem>
                        <SelectItem value="ACCESSORIES" className="focus:bg-purple-50">✨ Accessories</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="price" className="text-slate-600 font-medium">Price ($)</Label>
                    <Input
                      id="price"
                      type="number"
                      step="0.01"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="stock" className="text-slate-600 font-medium">Stock Quantity</Label>
                    <Input
                      id="stock"
                      type="number"
                      step="1"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="meaning" className="text-slate-600 font-medium">Symbolic Meaning</Label>
                  <Input
                    id="meaning"
                    ...
                    className="bg-white/80 border-purple-200 focus:border-purple-400 focus:ring-purple-200 rounded-xl"
                  />
                  <p className="text-xs text-slate-500 italic">What emotions or messages does this flower convey?</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="image" className="text-slate-600 font-medium">Image URL</Label>
                    <Input
                      id="image"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3 bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-100">
                      ...
                      />
                      <Label htmlFor="archived" className="text-slate-600 font-medium cursor-pointer">
                        Archive Product
                      </Label>
                    </div>
                  </div>
              ...
              <div className="flex justify-center space-x-4 pt-6 border-t border-purple-100">
                ...
                <Button 
                  type="button" 
                  variant="outline" 
                  onClick={() => {resetForm; startEdit ? setStartEdit(false) : setStartEdit(true)}}
